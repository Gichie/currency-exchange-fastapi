...
async def database_connection_exception_handler(request: Request, exc: Exception) -> JSONResponse:
...
async def currency_exists_handler(request: Request, exc: Exception) -> JSONResponse:
